...
num_episodes = 2000
memory_size =  min(2000,num_episodes) * 2000 #per action | roughly 50 episodes
...
for truncation_length in trunc_lens:
    ...
    for seed in [0,14]:
        ...
        for episode in tqdm(range(num_episodes)):
            ...
            #Log our data
            log_to_csv(episode, total_reward, epsilon, t, seed,folder=f"logs-{truncation_length}")
            if episode % 50 == 0 or episode == num_episodes - 1:
                save_checkpoint(
                    ...
                    epsilon, 
                    seed,
                    folder = f"checkpoints-{truncation_length}"
                )
